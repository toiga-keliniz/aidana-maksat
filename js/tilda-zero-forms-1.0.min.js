...
function t_zeroForms__createForm(t, e, r, o) {
    ...
    var l, _, i = document.createElement("div"),
...
function t_zeroForms__parseIntoElement(e, r, o, n, t, i) {
    ...
    return _.classList.add("t-input-error"), d.insertAdjacentElement("beforeend", _), l.insertAdjacentElement("beforeend", d), "h" !== n.inputpos && ("em" !== (c = o.li_type) && "ph" !== c && "nm" !== c && "in" !== c && "ta" !== c && "sb" !== c && "cb" !== c && "uw" !== c && "da" !== c && "tm" !== c && "qn" !== c && "rg" !== c && "ur" !== c && "tx" !== c || t_zeroForms__setFieldsRowClasses(p, l), "rd" === o.li_type && t_zeroForms__setRadioRowClasses(p, d)), l
}
...
function t_zeroForms__createRadio(i, a, s, l, _, c, d) {
    ...
    return t.forEach(function(t, e) {
        ...
        e.textContent = t, r.insertAdjacentElement("beforeend", e), t === i.li_ownvariant ? (n = t_zeroForms__createStyleObjectForOwnAnswer(l, a), e = t_zeroForms__createOwnAnswer(o, r, i, n, s, c, d), p.insertAdjacentElement("beforeend", e)) : p.insertAdjacentElement("beforeend", r)
...
function t_zeroForms__updateOwnAnswerVisibility(t, n) {
    t.forEach(function(o) {
        o.addEventListener("change", function() {
            var t, e = n.querySelector(".t-input__own-answer"),
...
function t_zeroForms__createRadioImage(n, i, a) {
    var t, s, e, l, _, c, d = "cb" === n.li_radcb;
    if (n.li_gallery) try {
        t = JSON.parse(n.li_gallery)
    } catch (t) {}
    if (t) return t = t_zeroForms__fromObjToArray(t), s = parseInt(n.li_defselitem, 10), e = document.createDocumentFragment(), l = t_zeroForms__createWrapper("t-img-select__container"), l.setAttribute("data-check-bgcolor", i.inputelscolor || "#000"), d && e.appendChild(t_zeroForms__createNameFieldForCheckbox(a, l, "img-select")), e.appendChild(l), _ = d ? "checkbox" : "radio", c = "t-img-select__indicator_" + (n.li_imgratio ? n.li_imgratio.replace("_", "-") : "1-1"), t.forEach(function(t, e) {
        var r = t_zeroForms__createLabel("img-select", "", !1),
            o = document.createElement("input"),
            e = (o.type = _, o.value = t.alt || t.img, o.classList.add("t-img-select"), d || (o.name = n.li_nm), d || o.classList.add("js-tilda-rule"), s && s === e + 1 && (o.checked = !0), a.require && o.setAttribute("data-tilda-req", "1"), r.insertAdjacentElement("beforeend", o), t_zeroForms__createIndicator("img-select", !1, {
                ratio: c,
                img: t.img
            }));
...
function t_zeroForms__generateBtnStyles(t, e, r, o, n) {
    ...
    i && i.parentElement && i.parentElement.removeChild(i), t_zeroForms__setScriptOrStyle(_, "", l, "style", n), a && (s = c.split(", ").map(function(t) {
        return t + ":hover"
...
function t_zeroForms__isFormOutside(e) {
    ...
    var i = !!r && r.getAttribute("data-artboard-ovrflw");
    if ("auto" === i || "visible" === i) return !1;
    var i = (i = r.classList.contains("t396__artboard_scale")) || "window" === t_zeroForms__getFieldValue(r, "data-artboard", "upscale"),
        r = "function" == typeof window.t396_isOnlyScalableBrowser && t396_isOnlyScalableBrowser(),
        a = -1 < navigator.userAgent.toLowerCase().indexOf("firefox"),
        s = e.scaleFactor || window.tn_scale_factor || 1,
        o = o.left,
        l = e.style.top,
        i = ((l = "number" == typeof(l = l && l.indexOf("px") ? parseInt(l, 10) : l) ? l : 0) < 0 && -50 < l && (l = 0), !i || r || a || (o *= s, l *= s), e.hasAttribute("data-animate-fix")),
        r = "scroll" === e.getAttribute("data-animate-prx"),
        a = 0 < t.height && l > t.height && !r;
    return l < 0 && !i && !r || a || n < o
}
...
function t_zeroForms__setRadioRowClasses(t, e) {
    var r = t.radioPosition,
        o = (void 0 !== r && "" !== r && (e.classList.add("t-input-block_rd-flex"), (o = {
            hor: "",
